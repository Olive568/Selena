      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center justify-center">
        <div className="grid w-full gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <section className="flex flex-col justify-center gap-4 rounded-[2rem] border border-border bg-card p-6 text-card-foreground shadow-2xl shadow-black/10 sm:p-8">
            ...
            <h1 className="text-3xl font-semibold tracking-tight sm:text-5xl">Track money without the clutter.</h1>
            <p className="max-w-lg text-sm leading-7 text-muted-foreground">
              Sign in to manage transactions, watch category spending, and keep your dashboard synced in real time.
            </p>
            ...
            <div className="grid gap-3 pt-4 sm:grid-cols-3">
              {[
                ...
                { title: "Categories", body: "Keep spending organized." },
              ].map((item) => (
